...
files or even download them you can go <a href="https://www.kaggle.com/competitions/store-sales-time-series-forecasting/data">over there</a> and check them for
yourself.</p>
<p>In case you are too lazy for that (I do not blame you), here is a summary of
...
<li>holidays vs transactions </li>
</ul>
...
daily transaction for each day. So first let's get the average number of
...
seasonality, when December comes the transactions grow to the
...
<p>Let's just do a correlation table, to make sure we are not imagining things.</p>
...
<p>as we can see a lot of them are located in pichincha, I wonder where is
pichincha in a map, do you know where it is? well let's find out.</p>
...
at each month. Now we only need to use plolty to graph</p>
...
year.</p>
<h2>do sales increase near holidays?</h2>
...
<p>Basically what we are going to do is the following:
- get all sales from 2013
- get all national holidays in 2013
- see if the daily number of sales is related to the national holidays</p>
...
highest sales, but not by that many. We would have to make a full statistical
...
<p>well I hope you found the graphs pretty and insightful, if you do that's great,
if you don't well that's is not so great.</p>
<p>I'll leave some resources if you want to do your charts/plots/graphs:</p>
<ul>
<li>
